const cityString = document.getElementsByClassName('weather-city');
const tempString = document.getElementsByClassName('weather-temp');
...
getWeatherImg = () => {
    ...
    if(weather === 'Mist' || weather === 'Smoke' || weather === 'Haze'|| weather === 'Dust'|| weather === 'Fog' || weather === 'Sand'|| weather === 'Ash') {
...
displayWeather = () => {
    ...
    let stringCity = `${this.city}`;
    let stringTemp = `Temperatur : ${this.temp} grader | Feels like: ${this.feel} grader`;
}
}
};
